...
% Title: Simulation of Crack Propagation in a Plate with a Preexisting Crack(v50)
% Description: This MATLAB script is designed to simulate the process of crack propagation in a plate with a preexisting crack under loading.
% The Peridynamics method is employed, which is a computational mechanics approach used to model material failure and crack growth.
% The script defines material points, crack surfaces, material properties, and loading conditions to simulate the crack growth process.
% Through time integration and adaptive dynamic relaxation, the script calculates the displacement, velocity, and acceleration of material points.
% Ultimately, the script visualizes the evolution of crack length over time and the damage distribution of material points.
...
%     if (tt == 250)
%         disp_250(2,1) = disp(1,1);
%         disp_250(2,2) = disp(1,2);
%     elseif (tt == 500)
%         disp_250(3,1) = disp(1,1);
%         disp_250(3,2) = disp(1,2);
%     elseif (tt == 750)
%         disp_250(4,1) = disp(1,1);
%         disp_250(4,2) = disp(1,2);
%     elseif (tt == 1000)
%         disp_250(5,1) = disp(1,1);
%         disp_250(5,2) = disp(1,2);
%     elseif (tt == 1249)
%         disp_250(6,1) = disp(4950,1);
%         disp_250(6,2) = disp(4950,2);
%     end
...
scale = 1;
colormap jet
% Scatter plot for coord_disp_pd_750_pwc
figure;
...
colormap jet
% Scatter plot for coord_disp_pd_1000_pwc
figure;
...
colormap jet
% Scatter plot for coord_disp_pd_1250_pwc
figure;
